...
class ChromeTestCase(unittest.TestCase):
    ...
    def test_cookie_transfer_to_requests(self):
        """Tested on http://testing-ground.webscraping.pro/login"""

        self.s.driver.get("http://testing-ground.webscraping.pro/login.html")
        ...
        response = self.s.get("http://testing-ground.webscraping.pro/login?mode=welcome")
    ...
    def test_cookie_transfer_to_selenium(self):
        ...
        self.s.cookies.set(
            "tdsess", "TEST_DRIVE_SESSION", domain="testing-ground.scraping.pro"
        )

        self.s.transfer_session_cookies_to_driver()
        self.s.driver.get("http://testing-ground.webscraping.pro/login?mode=welcome")
